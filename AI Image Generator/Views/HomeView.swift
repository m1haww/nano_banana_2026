    ...
    var body: some View {
        NavigationStack {
            ...
            .onChange(of: selectedTab) { newTab in
                // Când utilizatorul comută pe alt tab și revine, aducem Home
                // la starea root — altfel Create / All tools rămân push-uite.
                if newTab != .home {
                    showCreate = false
                    showAllTools = false
                }
...
private struct BeforeAfterSlider: View {
    ...
    var body: some View {
        ...
        .onAppear {
            // La fiecare intrare pe view (inclusiv întoarcere din alt tab
            // sau altă pagină) readucem divider-ul în centru.
            sliderFraction = 0.5
        }
    }
